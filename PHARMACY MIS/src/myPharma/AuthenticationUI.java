...
public class AuthenticationUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Authentication - MyPharma");
        setPreferredSize(new java.awt.Dimension(650, 470));
        setResizable(false);

        authenticationPanel.setBackground(new java.awt.Color(249, 251, 253));
        ...
        headerL.setText("MyPharma Pharmacy MIS");

        mottoL.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        mottoL.setForeground(new java.awt.Color(255, 0, 0));
        mottoL.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        mottoL.setText("For all your Pharmaceutical Software needs!");
        ...
        logginJB.setBackground(new java.awt.Color(255, 204, 153));
        ...
        clearJB.setBackground(new java.awt.Color(255, 204, 153));
