...
public class Authenticator extends DB {
    ...
    public void checkPassword(String password) {
        ...
        // method called in passwordJTF on FocusOut. Remember try..catch and after if(!isBlank())
    ...
    public void loadUI(String username, String password, JLabel passwordJL, JTextField usernameTF, JPasswordField passwordTF) {
        ...
        if(isHasStaffId() == false && isHasPassword() == false){
           JOptionPane.showMessageDialog( null, "Access Denied!\nConsult your Administrator.", 
                   "MyPharma- Authentication Error", JOptionPane.ERROR_MESSAGE );
        }
    ...
    /* function validates drug prescription value */
    public static boolean validatePrescription(String prescription) {
        return prescription.matches("([1-5]X[1-5])|([1-5]\\sX\\s[1-5])");
    }
