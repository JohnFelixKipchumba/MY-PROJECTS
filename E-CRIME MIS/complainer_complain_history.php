...
<head>
    ...
    if(isset($_POST['s2']))
    {
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $resu=mysqli_query($conn,"SELECT c_id FROM complaint where u_id='$u_id' and c_id='$cid'");
    ...
    $query="select c_id,type_crime,d_o_c,location from complaint where u_id='$u_id' order by c_id desc";
