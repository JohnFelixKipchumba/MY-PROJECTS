...
if(isset($_POST['s'])){
    ...
    mysqli_select_db($con,"crime-portal");
    if(!$con)
    {
    ...
    $reg="insert into police_station (i_id,i_pass,i_name,location) values('$i_id','$u_pass','$i_name','$loc')";
...
<div class="video" style="margin-top: 5%"> 
	<div class="center-container">
      ...
      Incharge Name
					...
					Password<br><input type="password"  name="password" placeholder="Password" required="" id="pas" onfocusout="f1()"/>
