...
<head>
    ...
    mysqli_select_db($conn,"crime-portal");
    
    $cid=$_SESSION['cid'];
    $p_id=$_SESSION['pol'];

    $query="select c_id,type_crime,d_o_c,description,u_addr from complaint natural join user where c_id= '$cid' and p_id= '$p_id'";
    ...
    if(isset($_POST['status'])){
        if($_SERVER["REQUEST_METHOD"]=="POST")
        {
            ...
            $q1=mysqli_query($conn,"update complaint set pol_status='In process' where c_id='$cid'");
