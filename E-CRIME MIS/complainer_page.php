...
session_start();
    ...
    $conn=mysqli_connect("localhost","root","","crime-portal");
    if(!$conn)
    {
    ...
    $u_id=$_SESSION['u_id'];
        ...
        while($q2=mysqli_fetch_assoc($result1)) {
          $u_name=$q2['u_name'];
        }      
  ...
  if(isset($_POST['s'])){
    ...
    {
      switch ($type_crime) {
        case "Murder": $pid = "a101";
        break;
        case "Robbery": $pid = "t101";
        break;
        default: $pid = "a102"; 
      }     
      $comp="insert into complaint (u_id,location,type_crime,d_o_c,description,p_id) values('$u_id','$location','$type_crime','$d_o_c','$description','$pid')"; 
